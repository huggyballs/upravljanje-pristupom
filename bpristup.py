...
try:
    ...
    pass
try:
    mycursor.execute("CREATE TABLE Logs (LogNum int PRIMARY KEY NOT NULL AUTO_INCREMENT, dt DATETIME NOT NULL, logType VARCHAR(11) NOT NULL, logMsg VARCHAR(100) NOT NULL)")
    db.commit()
    pass
except:
    print("postoji")
